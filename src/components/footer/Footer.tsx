...
function Footer({}: Props) {
  return (
    <Box url={images.main_bg} height="auto" shadow>
      <Box direction="column" js="space-between">
        <Box direction="column" gap="0.5em" height="auto" width="auto">
          ...
          <Text color="#fff" fontSize="0.67em" lineHeight={18}>
            ...
            aliquid non, itaque rem accusamus suscipit eveniet unde quia ratione
            consectetur facere, architecto quibusdam rerum vero est ea, adipisci
            maxime quas.
          </Text>
